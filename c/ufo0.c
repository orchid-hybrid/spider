...
struct scm map(struct scm env2498, struct scm f, struct scm l) {
    ...
    if (scm_extract_truth(r41)) {
        ...
        refcount_inc_one(env54);
        r47 = clo53(env54, r51);
        refcount_dec_one(clor52);
        scm_fptr clo49;
        struct scm env50;
        ...
        refcount_inc_one(env63);
        r56 = clo62(env63, r60);
        refcount_dec_one(clor61);
        scm_fptr clo58;
        struct scm env59;
...
struct scm stuff(struct scm env2498) {
    ...
    refcount_inc_one(env74);
    r65 = clo73(env74, r70, r71);
    refcount_dec_one(clor72);
    struct scm clor77;
    ...
    refcount_inc_one(env94);
    r85 = clo93(env94, r90, r91);
    refcount_dec_one(clor92);
    struct scm clor97;
    ...
    refcount_inc_one(env114);
    r105 = clo113(env114, r110, r111);
    refcount_dec_one(clor112);
    ...
    refcount_inc_one(env99);
    r86 = clo98(env99, r95, r96);
    refcount_dec_one(clor97);
    scm_fptr clo88;
    struct scm env89;
...
struct scm g2499(struct scm env2498, struct scm selector) {
    ...
    struct scm clor150;
    clor150 = selector;
    r153 = (struct scm){ .tag = 0, .val.i = 0 };
    r154 = env2498;
    r155 = (struct scm){ .tag = 0, .val.i = 1 };
    r148 = scm_vector_ref(r153, r154, r155);
    r156 = (struct scm){ .tag = 0, .val.i = 0 };
    r157 = env2498;
    r158 = (struct scm){ .tag = 0, .val.i = 0 };
    r149 = scm_vector_ref(r156, r157, r158);
    scm_fptr clo151;
    struct scm env152;
    clo151 = clor150.val.v->elt[0].val.f;
    env152 = clor150.val.v->elt[1];
    refcount_inc_one(env152);
    r147 = clo151(env152, r148, r149);
    refcount_dec_one(clor150);
    return r147;
}
