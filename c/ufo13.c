...
struct scm reverse_aux(struct scm env2498, struct scm ls, struct scm o) {
    ...
    if (scm_extract_truth(r86)) {
        ...
        refcount_inc_one(env95);
        r87 = clo94(env95, r92);
        refcount_dec_one(clor93);
        struct scm clor98;
...
struct scm foo(struct scm env2498, struct scm l, struct scm r, struct scm n) {
    ...
    if (scm_extract_truth(r122)) {
        ...
        refcount_inc_one(env132);
        r123 = clo131(env132, r128, r129);
        refcount_dec_one(clor130);
        r134 = n;
        ...
        refcount_inc_one(env144);
        r135 = clo143(env144, r140, r141);
        refcount_dec_one(clor142);
...
struct scm print_numbers(struct scm env2498, struct scm l, struct scm n) {
    ...
    if (scm_extract_truth(r146)) {
        ...
        refcount_inc_one(env178);
        r171 = clo177(env178, r175);
        refcount_dec_one(clor176);
        scm_fptr clo173;
        struct scm env174;
        ...
        refcount_inc_one(env187);
        r179 = clo186(env187, r184);
        refcount_dec_one(clor185);
        struct scm clor190;
...
struct scm scm_main(struct scm env2498) {
    ...
    refcount_inc_one(env204);
    r194 = clo203(env204, r200, r201);
    refcount_dec_one(clor202);
    struct scm clor212;
...
struct scm g2505(struct scm env2498, struct scm fwd, struct scm bwd) {
    ...
    refcount_inc_one(env230);
    r221 = clo229(env230, r226, r227);
    refcount_dec_one(clor228);
    struct scm clor234;
    ...
    refcount_inc_one(env240);
    r232 = clo239(env240, r237);
    refcount_dec_one(clor238);
    struct scm clor244;
    ...
    refcount_inc_one(env251);
    r241 = clo250(env251, r247, r248);
    refcount_dec_one(clor249);
    struct scm clor255;
    ...
    refcount_inc_one(env263);
    r243 = clo262(env263, r259, r260);
    refcount_dec_one(clor261);
    scm_fptr clo245;
    struct scm env246;
    ...
    refcount_inc_one(env225);
    r220 = clo224(env225, r221, r222);
    refcount_dec_one(clor223);
    return r220;
}
...
struct scm g2503(struct scm env2498, struct scm c) {
    ...
    refcount_inc_one(env278);
    r273 = clo277(env278, r274, r275);
    refcount_dec_one(clor276);
    return r273;
}
...
struct scm g2502(struct scm env2498, struct scm c) {
    ...
    refcount_inc_one(env284);
    r279 = clo283(env284, r280, r281);
    refcount_dec_one(clor282);
    return r279;
}
...
struct scm g2499(struct scm env2498, struct scm selector) {
    ...
    refcount_inc_one(env292);
    r287 = clo291(env292, r288, r289);
    refcount_dec_one(clor290);
    return r287;
}
